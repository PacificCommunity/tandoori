...
setMethod(
  "fmort", signature(object = "simpleFisheries", year = "missing", season = "missing"),
  function(object) {
    # Just sel * q * effort
...
setMethod(
  "fmort", signature(object = "simpleFisheries", year = "numeric", season = "numeric"),
...
setMethod(
  "get_survivors_and_catch", signature(fisheries = "simpleFisheries", biol = "simpleBiol"),
