...
find_effort <- function(n_pre_move, m, waa, movement, selq, effort_mult_initial, target, target_type, fishery_area) {
    .Call(`_tandoori_find_effort`, n_pre_move, m, waa, movement, selq, effort_mult_initial, target, target_type, fishery_area)
}
